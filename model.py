...
class Model:
    ...
    def check_workspace_ready(self):
        return self.files_exists(['time_expanded.txt', ''''time_expanded-tram.txt', 'time_expanded-train.txt','time_expanded-bus.txt','time_expanded-tram-train.txt','time_expanded-metro-bus.txt','time_expanded-train-bus.txt','time_expanded-tram-train-bus.txt','condensed.txt','condensed-tram.txt','condensed-train.txt','condensed-bus.txt','condensed-tram-train.txt','condensed-tram-bus.txt','condensed-train-bus.txt', 'condensed-tram-train-bus.txt','alpha_beta.txt','alpha_beta-tram.txt','alpha_beta-train.txt','alpha_beta-bus.txt','alpha_beta-tram-train.txt','alpha_beta-tram-bus.txt','alpha_beta-train-bus.txt','alpha_beta-tram-train-bus.txt' ''' ])
