...
class App:
    def __init__(self, qApp):
        ...
        while not self.model.check_workspace():
            self.view.show_error('Mauvais espace de travail', 'Veuillez selectionner un espace de travail ou des donnees GTFS sont presentes')
        ...
        if not self.model.check_workspace_ready():
            self.view.inform("Espace de travail non initialise", "Votre espace de travail n'est pas initialise. Cette procedure dure environ 15 minutes. Validez pour continuer")
